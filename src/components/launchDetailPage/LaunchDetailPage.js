        ...
        <div className='launchDetail-basicInfo'>
          <div className='launchDetail-basicInfo-launch'>
            <div className='launchDetail-basicInfo-launch-numpatch'>
              <div>
                <img style={{ width: '100px', paddingLeft: '20px' }} src={singleLaunchData.links.patch.small} alt="" />  
              </div>
              <div style={{ fontSize: '90px', paddingRight: '30px', marginTop: '-10px' }}>{singleLaunchData.flight_number}</div>
            </div>
            <div>{singleLaunchData.name}</div>
